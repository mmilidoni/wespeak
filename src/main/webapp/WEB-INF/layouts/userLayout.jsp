        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                    <tiles:insertAttribute name="nextCalls" 
                                           ignore="true" 
                                           defaultValue="/WEB-INF/include/nextCalls.jsp" />
                    <tiles:insertAttribute name="suggestedTopics" 
                                           ignore="true" 
                                           defaultValue="/WEB-INF/include/suggestedTopics.jsp" />
                    <tiles:insertAttribute name="latestCalls" 
                                           ignore="true" 
                                           defaultValue="/WEB-INF/include/latestCalls.jsp" />
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        app.controller("UserController", function ($scope, $http) {
            $scope.nextCalls = function () {
                $http.post("<s:url action="nextCalls" />")
            ...
            $scope.lastCalls = function () {
                $http.post("<s:url action="lastCalls" />")
                        .then(function (response) {
                            console.log(response);
                            if (response.data.error) {
                                alert(response.data.error);
